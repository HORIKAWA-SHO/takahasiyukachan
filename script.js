  ...
  const cvnData = {
    seven: {
      ...
      combos: [
        ...
        { items: [
          { text: '手巻寿司（ツナ）', kcal: 170 },
          { text: 'サラダフィッシュ（スティック）', kcal: 90 },
          { text: 'グリーンサラダ（ドレッシング少量）', kcal: 70 },
          { text: 'たまごスープ', kcal: 60 },
          { text: 'ヨーグルト無糖（小）', kcal: 110 }
        ]}
      ]
    },
    lawson: {
      ...
      combos: [
        ...
        { items: [
          { text: 'おにぎり（ツナマヨ・小）', kcal: 170 },
          { text: 'ローストチキン（少量）', kcal: 90 },
          { text: 'チキンサラダ（ドレッシング少量）', kcal: 110 },
          { text: 'コーンスープ（小）', kcal: 120 },
          { text: 'みかん（小）', kcal: 40 }
        ]},
        { items: [
          { text: 'ブランロール', kcal: 150 },
          { text: 'サラダフィッシュ（スティック）', kcal: 90 },
          { text: 'ベーシックサラダ（ドレッシング少量）', kcal: 80 },
          { text: 'ミネストローネ（小）', kcal: 110 },
